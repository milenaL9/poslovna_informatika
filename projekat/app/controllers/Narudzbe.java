...
public class Narudzbe extends Controller {
	...
	public static void create(Narudzba narudzba,Long preduzece, Long poslovnaGodina,Long poslovniPartner){
		validation.clear();
	...
	public static void nextForm(Long id,String forma) throws ParseException{
		...
		if (forma.equals("stavkeNarudzbe")) {
			...
			List<StavkaCenovnika> stavkeCenovnika = StavkeNarudzbe.fillListStavkeCenovnika();
